package it.uniroma3.siw.silph_spa.auth;
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeRequests()
                    ...
                    .antMatchers(HttpMethod.GET, "/", "/byFotografo/*").permitAll()
                    
                    .antMatchers(HttpMethod.GET, "/", "/byAlbum/*").permitAll()
                    
                    .antMatchers(HttpMethod.GET, "/", "/aggiungiRichiesta/*").permitAll()
                    
                    .antMatchers(HttpMethod.POST, "/", "/inserisciRichiesta").permitAll()
                    .antMatchers(HttpMethod.GET, "/", "/inserisciRichiesta").permitAll()

                    .antMatchers(HttpMethod.POST, "/", "/inserimentoRichiesta").permitAll()
                    .antMatchers(HttpMethod.GET, "/", "/inserimentoRichiesta").permitAll()
